module Jekyll
  class Scholar
    ...
    class BibliographyTagByImaging < Liquid::Tag
      ...
      def render(context)
        ...
        @query = @article
        items = entries
        items = entries.select { |e| e.imaging == imaging}
        ...
        bibliography = "" #render_header(@type_labels[imaging])
...
Liquid::Template.register_tag('bibliography_byimaging', Jekyll::Scholar::BibliographyTagByImaging)
